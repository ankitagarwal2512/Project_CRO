  ...
  return (
    <div className="min-h-full">
      ...
      <main>
        ...
        <section className="mx-auto flex max-w-[1040px] flex-col items-center px-6 pb-12 pt-6 text-center sm:pt-9">
          ...
          <h1 className="mt-4 font-display text-[clamp(30px,4.4vw,64px)] font-semibold leading-[0.98] tracking-[-0.032em] text-[var(--ink)]">
          ...
          <p className="mt-[18px] w-full max-w-[600px] text-balance text-[18.5px] leading-[1.58] tracking-[-0.005em] text-[var(--muted)]">
