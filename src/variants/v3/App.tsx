...
/* The flowing ribbon band from go.hrone.cloud — their 614x191 artwork at 9%, stretched
   past both edges so the curves run off-screen rather than terminating in view. In v3 it
   backs the headline only and is anchored to the bottom of that block, so the curves run
   into the top edge of the dark stage instead of being buried behind it. */
function HeroBackdrop() {
  return (
    <div aria-hidden className="pointer-events-none absolute inset-0 z-0 overflow-hidden">
      <div className="absolute bottom-0 left-[-4%] w-[108%] opacity-[0.06]">
        <svg viewBox="0 0 614 191" width="100%" className="h-auto" preserveAspectRatio="none" fill="none">
...
export default function App() {
  return (
    <div className="min-h-full">
      ...
      <main>
        {/* hero copy — the backdrop is scoped to this block, not to the product below */}
        <div className="relative overflow-hidden">
          <HeroBackdrop />

          <section className="relative z-10 mx-auto flex max-w-[1040px] flex-col items-center px-6 pb-14 pt-10 text-center sm:pt-14">
