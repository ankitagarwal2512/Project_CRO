...
export function Trust() {
  /* Padding on neither edge of the section: the marquee's rule opens it and the logo
     band's own padding closes the page, so each row stays centred against its own rule
     rather than depending on two separate paddings agreeing with each other. */
  return (
